...
In order to hide **Native Bridge Injection** you have to edit build.prop file which is located in system partion ```ro.dalvik.vm.native.bridge build.prop=0``` value to ```#ro.dalvik.vm.native.bridge build.prop=0``` . Save file and reboot.
